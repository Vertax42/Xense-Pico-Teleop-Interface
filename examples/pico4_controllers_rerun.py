...
def log_controller_mesh(entity_path: str, position: tuple, quaternion: tuple, color: tuple):
    ...
    rr.log(
        ...
        rr.Boxes3D(
            ...
            rotations=[rr.Quaternion(xyzw=[qx, qy, qz, qw])],
            colors=[color],
        )
    )
        ...
        while True:
            ...
            if num_trackers > 0:
                ...
                for idx in range(num_trackers):
                    ...
                    entity_path = f"world/trackers/{sn}"
            ...
            # === Log scalar values ===
            rr.log("inputs/left_trigger", rr.Scalar(left_trigger))
            rr.log("inputs/right_trigger", rr.Scalar(right_trigger))
            rr.log("inputs/left_grip", rr.Scalar(left_grip))
            rr.log("inputs/right_grip", rr.Scalar(right_grip))
